  ...
  const patients = useMemo(() => {
    ...
    for (const a of appointments) {
      ...
      map.set(a.patient.id, {
        id: a.patient.id, fullName: a.patient.fullName, email: a.patient.email,
        lastVisit, lastStatus, lastReason, totalCount, hasActive, hasUrgent,
      });
    }
  ...
  return (
    <div className={
      ...
      <div>
        ...
        <h3 className={'text-2xl font-bold mt-1 ' + (accent ? 'text-amber-600' : 'text-slate-900 dark:text-slate-100')}>{value}</h3>
      </div>
