...
const SIDE_NAV = [
  { icon: 'dashboard',  label: 'Dashboard', to: '/doctor/dashboard' },
  { icon: 'group',      label: 'Patients',  to: '/doctor/patients'  },
  { icon: 'analytics',  label: 'Imaging',   to: '#', active: true   },
  { icon: 'description',label: 'Reports',   to: '/doctor/records'   },
];
  ...
  return (
    <div className="bg-background-light dark:bg-background-dark font-display text-slate-900 dark:text-slate-100 antialiased overflow-hidden">
      <div className="flex h-screen w-full">
        {/* Sidebar */}
        <aside className="w-20 lg:w-64 bg-primary flex flex-col items-center lg:items-stretch py-6 border-r border-primary/20 shrink-0">
          <div className="px-6 mb-10 flex items-center gap-3">
            ...
            <div className="hidden lg:block">
              <h1 className="text-white font-bold text-lg leading-none">MediConnect</h1>
              <p className="text-white/70 text-xs mt-1">Radiology Suite</p>
            </div>
          </div>
          ...
          <div className="px-3 mt-auto">
            <button
              ...
              className="w-full flex items-center justify-center lg:justify-start gap-3 px-3 py-2 text-white/70 hover:bg-white/10 rounded-lg transition-colors mb-2"
            >
